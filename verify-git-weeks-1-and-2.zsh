...
#    ca282
#    ca282/week-01
#    ca282/week-01/find-all-empty-files.sh
#    ca282/week-01/find-all-files.sh
#    ca282/week-01/hello.sh
#    ca282/week-01/untar-again.sh
#    ca282/week-02
#    ca282/week-02/echo-arguments.sh
#    ca282/week-02/first-non-file.sh
#
...
# ADDED (20/1020 @ 20:00)
#
# Some people are encountering errors which seem to arise from files which were copied
...
for file in hello.sh find-all-files.sh find-all-empty-files.sh untar-again.sh
do
...
(
   cd t
   sh ../find-all-files.sh | sort | sed 's/^/  |/'
)

print -l "" "test find-all-empty-files.sh..."
(
   cd t
   sh ../find-all-empty-files.sh | sort | sed 's/^/  |/'
)
...
for file in echo-arguments.sh first-non-file.sh
do
...
execute sh echo-arguments.sh dog cat mouse "snow leopard"

print -l "" "test first-non-file.sh..."
print -l /etc/passwd /var /home | execute sh first-non-file.sh | sed 's/^/  |/'
